...
- Gerenciamento de Colheitas:
  - Atualização da data de início da colheita.
  - Cálculo dos dias restantes para a colheita.
  - Histórico de colheitas anteriores.

- Gestão de Vendas:
  - Registro de novos produtos à venda.
  - Atualização de preços de produtos existentes.
  - Exibição de uma tabela de vendas.

- Sugestões de Sementes:
  - Recomendações de sementes adequadas para diferentes tipos de solo.

- Gestão de Feedbacks:
  - Registro de feedbacks de clientes.
  - Exibição de todos os feedbacks registrados.

- Tipos de Solo:
  - Informações sobre os diferentes tipos de solo e suas características.


# Requisitos

- Python 3.x
- Caso a Máquina seja Mac altera o código de limpesa de terminal ('cls') para ('clear')
